...
class Authentication {
   ...
   * })
   */
  static simple({ deploymentId = _authentications.Simple.DEFAULT_DEPLOYMENT_ID, login, password }) {
   ...
   * })
   */
  static delegating({ deploymentId = _authentications.Delegating.DEFAULT_DEPLOYMENT_ID, token }) {
    return Authentication.create({
