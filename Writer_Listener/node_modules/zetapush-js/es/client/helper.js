...
class ClientHelper {
   ...
   */
  constructor({ apiUrl, sandboxId, forceHttps = false, authentication, resource = null, transports = _zetapushCometd.Transports }) {
    /**
     * @access private
     * @type {string}
     */
     ...
     * @type {Promise}
     */
    this.servers = (0, _index.getServers)({ apiUrl, sandboxId, forceHttps, transports }).catch(error => {
